...
A Flask-based web application for tracking waste locations, clustering reports using K-means algorithm, and optimizing collection routes.

d**: Manage reports, run clustering, and view analytics
